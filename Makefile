...
BUILD         :=  build
LIBBUTANO     :=  /Users/saravieira/Documents/butano/butano
PYTHON        :=  python3
SOURCES       :=  src
INCLUDES      :=  include ../../Documents/butano/common/include
DATA          :=
GRAPHICS      :=  graphics ../../Documents/butano/common/graphics
AUDIO         :=  audio ../../Documents/butano/common/audio
AUDIOBACKEND  :=  maxmod
AUDIOTOOL     :=
DMGAUDIO      :=  dmg_audio ../../Documents/butano/common/dmg_audio
